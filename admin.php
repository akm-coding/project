                    ...
                    <td>
                        <?php if($auth->value > 1): ?>
                            <div class="btn-group dropdown">
                                ...
                                data-bs-toggle="dropdown">Change Role
                            </a>
                        ...
                        <?php if($auth->value >= 2): ?>
                            <?php if($user->suspended): ?>
                                <a href="_actions/unsuspended.php?id=<?= $user->id ?>" class="btn btn-warning btn-sm">Unban</a>
                            <?php else: ?>
                                <a href="_actions/suspended.php?id=<?= $user->id ?>" class="btn btn-secondary btn-sm">Ban</a>
                        <?php endif ?>
                        <?php endif ?>
